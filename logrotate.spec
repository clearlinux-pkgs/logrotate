...
Source0  : https://github.com/logrotate/logrotate/releases/download/3.20.1/logrotate-3.20.1.tar.xz
Source1  : logrotate.service
Source2  : logrotate.timer
Source3  : https://github.com/logrotate/logrotate/releases/download/3.20.1/logrotate-3.20.1.tar.xz.asc
...
%prep
%setup -q -n logrotate-3.20.1
cd %{_builddir}/logrotate-3.20.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653505160
...
cp %{_builddir}/logrotate-3.20.1/COPYING %{buildroot}/usr/share/package-licenses/logrotate/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
