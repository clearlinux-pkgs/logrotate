...
Source0  : https://github.com/logrotate/logrotate/releases/download/3.21.0/logrotate-3.21.0.tar.xz
Source1  : logrotate.service
Source2  : logrotate.timer
Source3  : https://github.com/logrotate/logrotate/releases/download/3.21.0/logrotate-3.21.0.tar.xz.asc
...
%prep
%setup -q -n logrotate-3.21.0
cd %{_builddir}/logrotate-3.21.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702028984
